                        ...
                        <div className="relative space-y-2 md:space-y-3">
                            ...
                            <div className="overflow-hidden">
                                ...
                                >
                                    ...
                                    >
                                        <GiHolosphere className="w-12 h-12 sm:w-14 sm:h-14 md:w-12 md:h-12 lg:w-16 lg:h-16 xl:w-20 xl:h-20 text-green-400 drop-shadow-[0_5px_5px_rgba(34,197,94,0.5)]" />
                                    </motion.span>
